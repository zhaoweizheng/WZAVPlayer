...
#import "MSTPlayerView.h"
#import "MSTPrefixHeader.h"

@implementation MSTPlayerView
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        [self addSubview:self.repeatPlayingBtn];
...
- (void)resetControlView {
    ...
    self.repeatPlayingBtn.hidden = YES;
    self.repeatPlayingBtn.hidden = YES;
...
{
    _resolutionNameArray= resolutionArray;
...
- (UIButton *)backBtn
{
    if (!_backBtn) {
        ...
        [_backBtn setImage:[UIImage imageNamed:MSTPlayerSrcName(@"ZFPlayer_back_full")] forState:UIControlStateNormal];
    }
    return _backBtn;
}
...
- (UIImageView *)topImageView
{
    if (!_topImageView) {
        ...
        _topImageView.image                  = [UIImage imageNamed:MSTPlayerSrcName(@"ZFPlayer_top_shadow")];
    }
...
- (UIImageView *)bottomImageView
{
    if (!_bottomImageView) {
        ...
        _bottomImageView.image                  = [UIImage imageNamed:MSTPlayerSrcName(@"ZFPlayer_bottom_shadow")];
    }
...
- (UIButton *)lockBtn
{
    if (!_lockBtn) {
        ...
        [_lockBtn setImage:[UIImage imageNamed:MSTPlayerSrcName(@"ZFPlayer_unlock-nor")] forState:UIControlStateNormal];
        [_lockBtn setImage:[UIImage imageNamed:MSTPlayerSrcName(@"ZFPlayer_lock-nor")] forState:UIControlStateSelected];
    }
    return _lockBtn;
}
...
- (UIButton *)startBtn
{
    if (!_startBtn) {
        ...
        [_startBtn setImage:[UIImage imageNamed:MSTPlayerSrcName(@"ZFPlayer_play")] forState:UIControlStateNormal];
        [_startBtn setImage:[UIImage imageNamed:MSTPlayerSrcName(@"ZFPlayer_pause")] forState:UIControlStateSelected];
    }
    return _startBtn;
}
...
- (UISlider *)videoSlider
{
    if (!_videoSlider) {
        ...
        // 设置slider
        [_videoSlider setThumbImage:[UIImage imageNamed:MSTPlayerSrcName(@"ZFPlayer_slider")] forState:UIControlStateNormal];
...
- (UIButton *)fullScreenBtn
{
    if (!_fullScreenBtn) {
        ...
        [_fullScreenBtn setImage:[UIImage imageNamed:MSTPlayerSrcName(@"ZFPlayer_fullscreen")] forState:UIControlStateNormal];
        [_fullScreenBtn setImage:[UIImage imageNamed:MSTPlayerSrcName(@"ZFPlayer_shrinkscreen")] forState:UIControlStateSelected];
    }
...
- (UILabel *)horizontalLabel
{
    if (!_horizontalLabel) {
        ...
        _horizontalLabel.backgroundColor = [UIColor colorWithPatternImage:[UIImage imageNamed:MSTPlayerSrcName(@"ZFPlayer_management_mask")]];
    }
...
- (UIButton *)repeatBtn
{
    if (!_repeatPlayingBtn) {
        _repeatPlayingBtn = [UIButton buttonWithType:UIButtonTypeCustom];
        [_repeatPlayingBtn setImage:[UIImage imageNamed:MSTPlayerSrcName(@"ZFPlayer_repeat_video")] forState:UIControlStateNormal];
    }
    return _repeatPlayingBtn;
}
...
- (UIButton *)downLoadBtn
{
    if (!_downLoadBtn) {
        ...
        [_downLoadBtn setImage:[UIImage imageNamed:MSTPlayerSrcName(@"ZFPlayer_download")] forState:UIControlStateNormal];
        [_downLoadBtn setImage:[UIImage imageNamed:MSTPlayerSrcName(@"ZFPlayer_not_download")] forState:UIControlStateDisabled];
    }
    return _downLoadBtn;
}
...
- (UIButton *)playeBtn
{
    if (!_playingBtn) {
        ...
        [_playingBtn setImage:[UIImage imageNamed:MSTPlayerSrcName(@"ZFPlayer_play_btn")] forState:UIControlStateNormal];
    }
    return _playingBtn;
}
